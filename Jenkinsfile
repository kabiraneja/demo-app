    ...
    stages {
        ...
        stage('Deploy to Docker') {
            steps {
                ...
                sh ' scp -i id_rsa /var/jenkins_home/workspace/demo-job-2/target/demo-2.jar root@43.204.145.193:~/'
                sh ' scp -i id_rsa /var/jenkins_home/workspace/demo-job-2/Dockerfile root@43.204.145.193:~/'
